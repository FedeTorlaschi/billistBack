...
router.post('/create', authenticateToken, [
    ...
    body('amount').notEmpty().withMessage('Monto faltante').isNumeric().withMessage('Monto inválido'),
...
//         body('project_id').isInt().withMessage('El ID del proyecto debe ser un número entero'),
